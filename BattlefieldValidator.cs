...
public static class BattlefieldValidator
{
    public static bool Validate(this int[,] field)
    {
        ...
        {
            if (NotOut(i + 1) && NotOut(j + 1) && field[i + 1, j + 1] == 1)
            {
                return true;
            }
